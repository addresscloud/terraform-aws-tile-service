...
resource "aws_api_gateway_method_response" "json_get_403" {
  rest_api_id = aws_api_gateway_rest_api.tile.id
  resource_id = aws_api_gateway_resource.tileset.id
  http_method = aws_api_gateway_method.json_get.http_method
  status_code = "403"
...
resource "aws_api_gateway_method_response" "json_get_500" {
  rest_api_id = aws_api_gateway_rest_api.tile.id
  resource_id = aws_api_gateway_resource.tileset.id
  http_method = aws_api_gateway_method.json_get.http_method
  status_code = "500"
...
resource "aws_api_gateway_method_response" "tile_get_403" {
  rest_api_id = aws_api_gateway_rest_api.tile.id
  resource_id = aws_api_gateway_resource.y.id
  http_method = aws_api_gateway_method.tile_get.http_method
  status_code = "403"
...
resource "aws_api_gateway_method_response" "tile_get_500" {
  rest_api_id = aws_api_gateway_rest_api.tile.id
  resource_id = aws_api_gateway_resource.y.id
  http_method = aws_api_gateway_method.tile_get.http_method
  status_code = "500"
...
resource "aws_api_gateway_method_response" "filekey_get_403" {
  rest_api_id = aws_api_gateway_rest_api.tile.id
  resource_id = aws_api_gateway_resource.filekey.id
  http_method = aws_api_gateway_method.filekey_get.http_method
  status_code = "403"
...
resource "aws_api_gateway_method_response" "filekey_get_500" {
  rest_api_id = aws_api_gateway_rest_api.tile.id
  resource_id = aws_api_gateway_resource.filekey.id
  http_method = aws_api_gateway_method.filekey_get.http_method
  status_code = "500"
