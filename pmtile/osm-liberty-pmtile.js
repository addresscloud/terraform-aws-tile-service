const style = JSON.parse(`{
  ...
  "sources": {
    "openmaptiles": {
      "type": "vector",
      "tiles": [
        "pmtiles://https://tile-demo.addresscloud.com/v1/tilefile/opmosm-pmtile/20220825/florence.pmtiles/{z}/{x}/{y}"
      ]
    }
  },
  "sprite": "https://maputnik.github.io/osm-liberty/sprites/osm-liberty",
  "glyphs": "https://api.maptiler.com/fonts/{fontstack}/{range}.pbf?key=xL1O40BUivKQpAgs4d2o",
  "layers": [
    {
      "id": "background",
      "type": "background",
